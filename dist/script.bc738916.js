...
window.addEventListener('scroll', function (awesomeParallax) {
  var target = document.querySelector('.back-text');
  var targetHead = document.querySelector('.head-img');
  var targetSmoke = document.querySelector('.smoke-img');
  var targetSpray = document.querySelector('.spray-img');
  var targetJp = document.querySelector('.back-jp-text');
  var targetPero = document.querySelector('.pero');
